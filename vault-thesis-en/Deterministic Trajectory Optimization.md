...
1. **Starts probabilistic**: the initial policy is a distribution over possible actions (the complete [[Sample Space]]).
...
4. **Iterates**: At each iteration, the policy becomes less uncertain. The risk parameter gamma controls the speed of [[Convergence]].
...
This is analogous to temperature in LLMs: high T -> more variation ([[Drift]]), low T -> more [[Determinism]]. The structure of [[Context]] is what makes low T work well instead of collapsing.
...
- **The thesis**: LLM + complete [[Ontology]] + [[Tool|tools]] -> deterministic output

The pattern: structured information + iterative refinement -> [[Convergence]] to [[Determinism]]. In the thesis, the "EM" is the [[Deterministic Feedback Loop]] -- each tool call cycle enriches the [[Context]], reduces the [[Sample Space]], and brings the response closer to deterministic.

"THIS PAPER HERE SAYS THAT COMPLETE CONTEXT (ONTOLOGY) YOU CAN REACH 89% DETERMINISM, WITHOUT NEEDING TO COMPUTE THE BEST PATH IN THE CALCULATION THOSE PHYSICS NERDS ARE DOING OVER THERE." The thesis achieves determinism through the completeness of the [[Ontology]], not through optimal computation -- but the convergent pattern is the same.

---

Related to: [[Determinism]], [[Convergence]], [[Ontology]], [[Ontological Tautology]], [[Sample Space]], [[Drift]], [[Deterministic Feedback Loop]], [[Tool]]
