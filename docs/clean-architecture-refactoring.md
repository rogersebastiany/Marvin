...
1. [the-clean-architecture.html](https://blog.cleancoder.com/uncle-bob/2012/08/13/the-clean-architecture.html)
2. [Catalog of Refactoring](https://refactoring.guru/refactoring/catalog)