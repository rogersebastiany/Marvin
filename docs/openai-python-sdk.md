...
[History](/openai/openai-python/commits/main/README.md)
...
The REST API documentation can be found on [platform.openai.com](https://platform.openai.com/docs/api-reference). The full API of this library can be found in [api.md](/openai/openai-python/blob/main/api.md).
...
The full API of this library can be found in [api.md](/openai/openai-python/blob/main/api.md).
...
client = OpenAI(
    # Or use the `OPENAI_BASE_URL` env     http_client=DefaultHttpxClient(
...
See [the contributing documentation](/openai/openai-python/blob/main/CONTRIBUTING.md).

---

## Bibliography

1. [OpenAI Python API library](https://github.com/openai/openai-python/blob/main/README.md)