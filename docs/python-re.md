...
Both patterns and strings to be searched can be Unicode strings ([`str`](stdtypes.html#str "str"))
as well as 8-bit strings ([`bytes`](stdtypes.html#bytes "bytes")).
...
usage of the backslash in string literals now generate a [`SyntaxWarning`](exceptions.html#SyntaxWarning "SyntaxWarning")
and in the future this will become a [`SyntaxError`](exceptions.html#SyntaxError "SyntaxError"). This behaviour
...
:   If zero or more characters at the *beginning* of *string* match this regular
    ...
    [`search()`](#re.Pattern.search "re.Pattern.search") method.
...
:   Returns one or more subgroups of the match. If there is a single argument, the
    ...
    string argument is not used as a group name in the pattern, an [`IndexError`](exceptions.html#IndexError "IndexError")
    exception is raised.
...
:   Return the indices of the start and end of the substring matched by *group*;
    ...
    *group* exists but did not contribute to the match. For a match object *m*, and
    ...
    2, and `m.start(2)` raises an [`IndexError`](exceptions.html#IndexError "IndexError") exception.
