...
The path from the local POC to AWS deployment. The same [[Cadeia de Servers]], but with authentication, encryption, multi-tenancy, and auditing. ~$115-125/month.
...
- **Private:** MCP servers + [[S3 como Ontologia Persistente|encrypted storage]] -- zero public access
...
**WAF (Web Application Firewall):** Rate limiting, IP allowlisting, attack pattern blocking. Part of the [[Três Camadas de Segurança|Transport]] layer.

**S3 + KMS:** [[S3 como Ontologia Persistente]] -- encrypted docs and diagrams. Separate keys per [[Tenant Isolation|tenant]].
...
| POC | Production |
|---|---|
| Local `docs/` | [[S3 como Ontologia Persistente]] with KMS |
...
Related to: [[MCP Gateway]], [[Três Camadas de Segurança]], [[Tenant Isolation]], [[S3 como Ontologia Persistente]], [[Cadeia de Servers]], [[stdio]], [[FastMCP]], [[Ontologia como Código]]
