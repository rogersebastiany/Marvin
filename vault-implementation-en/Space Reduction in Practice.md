...
Each tool call in the POC is a [[Dimensionality Reduction]] operation on the [[Sample Space]]. The model goes from operating in the entire S to operating in an increasingly smaller and more precise [[Subset]] A.
...
The model operates in the entire S -- the whole [[Matrix M]] is a candidate. High uncertainty, risk of [[Hallucination]].
...
Each step is a conditioning in [[Conditional Probability]]:
...
Together, the 4 servers attack the 4 main sources of uncertainty in the [[Sample Space]].

## Subset Intersection

In [[Set Theory]], each tool defines a subset T subset of S. The intersection of multiple tools refines:

- A (prompt) intersection T1 (docs) intersection T2 (search) intersection T3 (diagram) = highly precise subset

When this intersection contains few viable candidates, the response is nearly [[Tautology|tautological]] -- true by construction, not by probability.

---

Related to: [[Sample Space]], [[Subset]], [[Dimensionality Reduction]], [[Conditional Probability]], [[Set Theory]], [[Server Chain]], [[docs-server]], [[web-to-docs]], [[prompt-engineer]], [[system-design]], [[Programmatic Context]], [[Tautology]]
