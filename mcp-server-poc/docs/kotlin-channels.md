...
Channels | Kotlin Documentation[{"id":"channel-basics","level":0,"title":"Channel basics","anchor":"#channel-basics"},{"id":"closing-and-iteration-over-channels","level":0,"title":"Closing and iteration over channels","anchor":"#closing-and-iteration-over-channels"},{"id":"building-channel-producers","level":0,"title":"Building channel producers","anchor":"#building-channel-producers"},{"id":"pipelines","level":0,"title":"Pipelines","anchor":"#pipelines"},{"id":"prime-numbers-with-pipeline","level":0,"title":"Prime numbers with pipeline","anchor":"#prime-numbers-with-pipeline"},{"id":"fan-out","level":0,"title":"Fan-out","anchor":"#fan-out"},{"id":"fan-in","level":0,"title":"Fan-in","anchor":"#fan-in"},{"id":"buffered-channels","level":0,"title":"Buffered channels","anchor":"#buffered-channels"},{"id":"channels-are-fair","level":0,"title":"Channels are fair","anchor":"#channels-are-fair"},{"id":"ticker-channels","level":0,"title":"Ticker channels","anchor":"#ticker-channels"}]{
"@context": "http://schema.org",
"@type": "WebPage",
"@id": "https://kotlinlang.org/docs/channels.html#webpage",
"url": "https://kotlinlang.org/docs/channels.html",
"name": "Channels | Kotlin",
"description": "",
...
All functions that create coroutines are defined as extensions on [CoroutineScope](https://kotlinlang.org/api/kotlinx.coroutines/kotlinx-coroutines-core/kotlinx.coroutines/-coroutine-scope/index.html), so that we can rely on [structured concurrency](composing-suspending-functions.html#structured-concurrency-with-async) to make sure that we don't have lingering global coroutines in our application.
...
[Asynchronous Flow](flow.html)[Coroutine exceptions handling](exception-handling.html)