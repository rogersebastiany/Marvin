...
Cancellation and timeouts | Kotlin Documentation[{"id":"cancel-coroutines","level":0,"title":"Cancel coroutines","anchor":"#cancel-coroutines"},{"id":"cancellation-propagation","level":1,"title":"Cancellation propagation","anchor":"#cancellation-propagation"},{"id":"cancellation-is-cooperative","level":0,"title":"Make coroutines react to cancellation","anchor":"#cancellation-is-cooperative"},{"id":"suspension-points-and-cancellation","level":1,"title":"Suspension points and cancellation","anchor":"#suspension-points-and-cancellation"},{"id":"check-for-cancellation-explicitly","level":1,"title":"Check for cancellation explicitly","anchor":"#check-for-cancellation-explicitly"},{"id":"interrupt-blocking-code-when-coroutines-are-canceled","level":1,"title":"Interrupt blocking code when coroutines are canceled","anchor":"#interrupt-blocking-code-when-coroutines-are-canceled"},{"id":"handle-values-safely-when-canceling-coroutines","level":0,"title":"Handle values safely when canceling coroutines","anchor":"#handle-values-safely-when-canceling-coroutines"},{"id":"run-non-cancelable-blocks","level":1,"title":"Run non-cancelable blocks","anchor":"#run-non-cancelable-blocks"},{"id":"timeout","level":0,"title":"Timeout","anchor":"#timeout"}]{
"@context": "http://schema.org",
"@type": "WebPage",
"@id": "https://kotlinlang.org/docs/cancellation-and-timeouts.html#webpage",
"url": "https://kotlinlang.org/docs/cancellation-and-timeouts.html",
"name": "Cancellation and timeouts | Kotlin",
"description": "",
...
You can use cancellation to stop long-running coroutines that keep producing values even after other coroutines no longer need them, for example, in [pipelines](channels.html#pipelines).
...
For more information, see [Coroutine exceptions handling](exception-handling.html#cancellation-and-exceptions).
...
[Coroutines and channels − tutorial](coroutines-and-channels.html)[Composing suspending functions](composing-suspending-functions.html)