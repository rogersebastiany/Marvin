...
* Table of Contents
  ...
  + [SEPARATE CHANGES](#_separate_changes)
  + [MANAGING BRANCHES](#_managing_branches)
  + [DISTRIBUTED WORKFLOWS](#_distributed_workflows)
  + [SEE ALSO](#_see_also)
  + [GIT](#_git)
...
[Latest version
▾](#) 
gitworkflows last updated in 2.35.0

Changes in the **gitworkflows** manual

1. 2.35.1 → 2.53.0 no changes
2. [2.35.0

   *2022-01-24*](/docs/gitworkflows/2.35.0)
3. 2.28.1 → 2.34.8 no changes
4. [2.28.0

   *2020-07-27*](/docs/gitworkflows/2.28.0)
5. 2.23.1 → 2.27.1 no changes
6. [2.23.0

   *2019-08-16*](/docs/gitworkflows/2.23.0)
7. 2.18.1 → 2.22.5 no changes
8. [2.18.0

   *2018-06-21*](/docs/gitworkflows/2.18.0)
9. 2.17.0 → 2.17.6 no changes
10. [2.16.6

    *2019-12-06*](/docs/gitworkflows/2.16.6)
11. 2.13.7 → 2.15.4 no changes
12. [2.12.5

    *2017-09-22*](/docs/gitworkflows/2.12.5)
13. 2.1.4 → 2.11.4 no changes
14. [2.0.5

    *2014-12-17*](/docs/gitworkflows/2.0.5)
...
[git-blame[1]](/docs/git-blame) and [git-bisect[1]](/docs/git-bisect).
...
section of [git-stash[1]](/docs/git-stash).

## MANAGING BRANCHES

There are two main tools that can be used to include changes from one
branch on another: [git-merge[1]](/docs/git-merge) and
...
you will need to cherry-pick it (using [git-cherry-pick[1]](/docs/git-cherry-pick))
...
* If you find you forked off the wrong branch and want to move it
  "back in time", use [git-rebase[1]](/docs/git-rebase).

Note that the last point clashes with the other two: a topic that has
been merged elsewhere should not be rebased. See the section on
RECOVERING FROM UPSTREAM REBASE in [git-rebase[1]](/docs/git-rebase).
...
* [git-push[1]](/docs/git-push) copies your branches to a remote repository,
  usually to one that can be read by all involved parties;
* [git-fetch[1]](/docs/git-fetch) that copies remote branches to your repository;
  and
* [git-pull[1]](/docs/git-pull) that does fetch and merge in one go.
...
provides the [git-request-pull[1]](/docs/git-request-pull) to send preformatted pull
...
[git-format-patch[1]](/docs/git-format-patch) to generate the corresponding emails
...
See the [git-format-patch[1]](/docs/git-format-patch) and [git-send-email[1]](/docs/git-send-email)
...
in patches to figure out the merge base. See [git-am[1]](/docs/git-am) for
other options.
