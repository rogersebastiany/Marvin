...
# [Blue Green Deployment](BlueGreenDeployment.html)
...
- [Continuous
Delivery](/books/continuousDelivery.html). It builds upon many of the ideas that are commonly
associated with [Continuous
Integration](/articles/continuousIntegration.html), driving more towards this ability to rapidly put
...
requests go to the green environment - the blue one is now idle.
...
The two environments need to be different but as identical as
...
addresses for the two slices.

Once you've put your green environment live and you're happy with
...
version (for rollback) and staging the next version.

An advantage of this approach is that it's the same basic
...
The fundamental idea is to have two easily switchable
...
schema changes from application upgrades. So first apply a [database refactoring](/books/refactoringDatabases.html) to
...
This technique has been “out there” for ages, but I don't see it
used as often as it should be. Some foggy combination of [Daniel Terhorst-North](http://dannorth.net/) and Jez Humble [came up with the
name](https://gitlab.com/snippets/1846041).

## Further Reading

You can find much more detail on this and related techniques
from the [Continuous
Delivery book](/books/continuousDelivery.html) by Jez Humble and Dave Farley. My [guide page on
delivery](/delivery.html) points to more material on these topcis.
...
2015-06-05: The page got a lot more page traffic today as
Hacker News noticed it. So I added a paragraph on database
changes and the further reading section.
