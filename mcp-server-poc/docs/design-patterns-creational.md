...
Provides an interface for creating objects in a superclass, but allows subclasses to alter the type of objects that will be created.](/design-patterns/factory-method)
[Abstract Factory

Lets you produce families of related objects without specifying their concrete classes.](/design-patterns/abstract-factory)
[Builder

Lets you construct complex objects step by step. The pattern allows you to produce different types and representations of an object using the same construction code.](/design-patterns/builder)
[Prototype

Lets you copy existing objects without making your code dependent on their classes.](/design-patterns/prototype)
[Singleton

Lets you ensure that a class has only one instance, while providing a global access point to this instance.](/design-patterns/singleton)
...
* English
  ...
  [English](https://refactoring.guru/design-patterns/creational-patterns "English")
  [Español](https://refactoring.guru/es/design-patterns/creational-patterns "Español")
  [Français](https://refactoring.guru/fr/design-patterns/creational-patterns "Français")
  [日本語](https://refactoring.guru/ja/design-patterns/creational-patterns "日本語")
  [한국어](https://refactoring.guru/ko/design-patterns/creational-patterns "한국어")
  [Polski](https://refactoring.guru/pl/design-patterns/creational-patterns "Polski")
  [Português Brasileiro](https://refactoring.guru/pt-br/design-patterns/creational-patterns "Português Brasileiro")
  [Русский](https://refactoring.guru/ru/design-patterns/creational-patterns "Русский")
  [Українська](https://refactoring.guru/uk/design-patterns/creational-patterns "Українська")
  [中文](https://refactoringguru.cn/design-patterns/creational-patterns "中文")
