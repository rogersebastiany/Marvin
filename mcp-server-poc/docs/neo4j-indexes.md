...
* + [Introduction](../introduction/)
  ...
  + [Indexes](./)
    - [Search-performance indexes](search-performance-indexes/)
      * [Create indexes](search-performance-indexes/create-indexes/)
      * [Show indexes](search-performance-indexes/list-indexes/)
      * [Drop indexes](search-performance-indexes/drop-indexes/)
      * [The impact of indexes on query performance](search-performance-indexes/using-indexes/)
      * [Index hints for the Cypher planner](search-performance-indexes/index-hints/)
    - [Semantic indexes](semantic-indexes/)
      * [Full-text indexes](semantic-indexes/full-text-indexes/)
      * [Vector indexes](semantic-indexes/vector-indexes/)
    - [Syntax](syntax/)
  + [Schema](../schema/)
...
[Raise an issue](https://github.com/neo4j/docs-cypher/issues/new/?title=Docs%20Feedback%20modules/ROOT/pages/indexes/index.adoc%20(ref:%20cypher-25)&body=%3E%20Do%20not%20include%20confidential%20information,%20personal%20data,%20sensitive%20data,%20or%20other%20regulated%20data.)
...
* [Search-performance indexes](search-performance-indexes/), for speeding up data retrieval based on *exact* matches.
  This category includes range, text, point, and token lookup indexes.
* [Semantic indexes](semantic-indexes/), for *approximate* matches and to compute similarity scores between a query string and the matching data.
