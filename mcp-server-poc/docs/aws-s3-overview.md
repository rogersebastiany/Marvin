...
"@type" : "ListItem",
"position" : 4,
"name" : "What is Amazon S3?",
"item" : "https://docs.aws.amazon.com/AmazonS3/latest/userguide/Welcome.html"
}
]
}

[Documentation](/index.html)[Amazon Simple Storage Service (S3)](/s3/index.html)[User Guide](Welcome.html)

[Features of Amazon S3](#S3Features)[How Amazon S3 works](#CoreConcepts)[Amazon S3 data consistency model](#ConsistencyModel)[Related services](#RelatedAmazonWebServices)[Accessing Amazon S3](#API)[Paying for Amazon S3](#PayingforStorage)[PCI DSS compliance](#pci-dss-compliance)
