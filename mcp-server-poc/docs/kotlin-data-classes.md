...
Data classes | Kotlin Documentation[{"id":"properties-declared-in-the-class-body","level":0,"title":"Properties declared in the class body","anchor":"#properties-declared-in-the-class-body"},{"id":"copying","level":0,"title":"Copying","anchor":"#copying"},{"id":"data-classes-and-destructuring-declarations","level":0,"title":"Data classes and destructuring declarations","anchor":"#data-classes-and-destructuring-declarations"},{"id":"standard-data-classes","level":0,"title":"Standard data classes","anchor":"#standard-data-classes"}]{
"@context": "http://schema.org",
"@type": "WebPage",
"@id": "https://kotlinlang.org/docs/data-classes.html#webpage",
"url": "https://kotlinlang.org/docs/data-classes.html",
"name": "Data classes | Kotlin",
"description": "",
...
On the JVM, if the generated class needs to have a parameterless constructor, default values for the properties have to be specified (see [Constructors](classes.html#constructors-and-initializer-blocks)):
...
[Classes](classes.html)[Extensions](extensions.html)