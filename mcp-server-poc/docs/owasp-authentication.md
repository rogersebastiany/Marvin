...
[Skip to content](#authentication-cheat-sheet)
...
* Cheatsheets
  ...
  + Authentication
    ...
    - [Authentication General Guidelines](#authentication-general-guidelines)
      ...
      * [Reauthentication After Risk Events](#reauthentication-after-risk-events)

        + [When to Trigger Reauthentication](#when-to-trigger-reauthentication)
        + [Reauthentication Mechanisms](#reauthentication-mechanisms)
    ...
    - [Use of authentication protocols that require no password](#use-of-authentication-protocols-that-require-no-password)
      ...
      * [OAuth 2.0 and 2.1](#oauth-20-and-21)
      * [OpenID Connect (OIDC)](#openid-connect-oidc)

        + [OIDC implementation guidance](#oidc-implementation-guidance)
      * [SAML](#saml)
      * [FIDO](#fido)
    ...
    - [Adaptive or Risk Based Authentication](#adaptive-or-risk-based-authentication)
...
### Reauthentication After Risk Events[¶](#reauthentication-after-risk-events "Permanent link")
...
#### When to Trigger Reauthentication[¶](#when-to-trigger-reauthentication "Permanent link")
...
#### Reauthentication Mechanisms[¶](#reauthentication-mechanisms "Permanent link")
...
#### Implementation Recommendations[¶](#implementation-recommendations "Permanent link")
...
### OAuth 2.0 and 2.1[¶](#oauth-20-and-21 "Permanent link")
...
### OpenID Connect (OIDC)[¶](#openid-connect-oidc "Permanent link")
...
#### OIDC implementation guidance[¶](#oidc-implementation-guidance "Permanent link")
...
## Adaptive or Risk Based Authentication[¶](#adaptive-or-risk-based-authentication "Permanent link")
