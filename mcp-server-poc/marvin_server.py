...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "You have access to the complete ontology (Neo4j), episodic memory (Milvus), "
        "local documentation, prompt engineering, and system design capabilities. "
        "You can retrieve, log, enrich, evolve, and build."
    ),
)
