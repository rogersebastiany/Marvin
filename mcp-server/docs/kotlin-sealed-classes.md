...
Sealed classes and interfaces | Kotlin Documentation[{"id":"declare-a-sealed-class-or-interface","level":0,"title":"Declare a sealed class or interface","anchor":"#declare-a-sealed-class-or-interface"},{"id":"constructors","level":1,"title":"Constructors","anchor":"#constructors"},{"id":"inheritance","level":0,"title":"Inheritance","anchor":"#inheritance"},{"id":"inheritance-in-multiplatform-projects","level":1,"title":"Inheritance in multiplatform projects","anchor":"#inheritance-in-multiplatform-projects"},{"id":"use-sealed-classes-with-when-expression","level":0,"title":"Use sealed classes with when expression","anchor":"#use-sealed-classes-with-when-expression"},{"id":"use-case-scenarios","level":0,"title":"Use case scenarios","anchor":"#use-case-scenarios"},{"id":"state-management-in-ui-applications","level":1,"title":"State management in UI applications","anchor":"#state-management-in-ui-applications"},{"id":"payment-method-handling","level":1,"title":"Payment method handling","anchor":"#payment-method-handling"},{"id":"api-request-response-handling","level":1,"title":"API request-response handling","anchor":"#api-request-response-handling"}]{
"@context": "http://schema.org",
"@type": "WebPage",
"@id": "https://kotlinlang.org/docs/sealed-classes.html#webpage",
...
Java 15 introduced [a similar concept](https://docs.oracle.com/en/java/javase/15/language/sealed-classes-and-interfaces.html#GUID-0C709461-CC33-419A-82BF-61461336E65F), where sealed classes use the `sealed` keyword along with the `permits` clause to define restricted hierarchies.
...
In multiplatform projects, if you have a sealed class with a `when` expression as an [expected declaration](/docs/multiplatform/multiplatform-expect-actual.html) in your common code, you still need an `else` branch. This is because subclasses of `actual` platform implementations may extend sealed classes that aren't known in the common code.
...
[Object declarations and expressions](object-declarations.html)[Enum classes](enum-classes.html)