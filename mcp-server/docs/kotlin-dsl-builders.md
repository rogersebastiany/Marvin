...
Type-safe builders | Kotlin Documentation[{"id":"how-it-works","level":0,"title":"How it works","anchor":"#how-it-works"},{"id":"scope-control-dslmarker","level":0,"title":"Scope control: @DslMarker","anchor":"#scope-control-dslmarker"},{"id":"full-definition-of-the-com-example-html-package","level":1,"title":"Full definition of the com.example.html package","anchor":"#full-definition-of-the-com-example-html-package"}]{
...
[This expressions](this-expressions.html)[Using builders with builder type inference](using-builders-with-builder-inference.html)