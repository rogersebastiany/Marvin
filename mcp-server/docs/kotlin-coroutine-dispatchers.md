...
Coroutine context and dispatchers | Kotlin Documentation[{"id":"dispatchers-and-threads","level":0,"title":"Dispatchers and threads","anchor":"#dispatchers-and-threads"},{"id":"unconfined-vs-confined-dispatcher","level":0,"title":"Unconfined vs confined dispatcher","anchor":"#unconfined-vs-confined-dispatcher"},{"id":"debugging-coroutines-and-threads","level":0,"title":"Debugging coroutines and threads","anchor":"#debugging-coroutines-and-threads"},{"id":"debugging-with-idea","level":1,"title":"Debugging with IDEA","anchor":"#debugging-with-idea"},{"id":"debugging-using-logging","level":1,"title":"Debugging using logging","anchor":"#debugging-using-logging"},{"id":"jumping-between-threads","level":0,"title":"Jumping between threads","anchor":"#jumping-between-threads"},{"id":"job-in-the-context","level":0,"title":"Job in the context","anchor":"#job-in-the-context"},{"id":"children-of-a-coroutine","level":0,"title":"Children of a coroutine","anchor":"#children-of-a-coroutine"},{"id":"parental-responsibilities","level":0,"title":"Parental responsibilities","anchor":"#parental-responsibilities"},{"id":"naming-coroutines-for-debugging","level":0,"title":"Naming coroutines for debugging","anchor":"#naming-coroutines-for-debugging"},{"id":"combining-context-elements","level":0,"title":"Combining context elements","anchor":"#combining-context-elements"},{"id":"coroutine-scope","level":0,"title":"Coroutine scope","anchor":"#coroutine-scope"},{"id":"thread-local-data","level":1,"title":"Thread-local data","anchor":"#thread-local-data"}]{
"@context": "http://schema.org",
"@type": "WebPage",
"@id": "https://kotlinlang.org/docs/coroutine-context-and-dispatchers.html#webpage",
...
Debugging mode is also turned on when JVM is run with `-ea` option. You can read more about debugging facilities in the documentation of the [DEBUG\_PROPERTY\_NAME](https://kotlinlang.org/api/kotlinx.coroutines/kotlinx-coroutines-core/kotlinx.coroutines/-d-e-b-u-g_-p-r-o-p-e-r-t-y_-n-a-m-e.html) property.
...
[Composing suspending functions](composing-suspending-functions.html)[Asynchronous Flow](flow.html)