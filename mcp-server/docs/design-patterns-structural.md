...
Allows objects with incompatible interfaces to collaborate.](/design-patterns/adapter)
[Bridge

Lets you split a large class or a set of closely related classes into two separate hierarchies—abstraction and implementation—which can be developed independently of each other.](/design-patterns/bridge)
[Composite

Lets you compose objects into tree structures and then work with these structures as if they were individual objects.](/design-patterns/composite)
[Decorator

Lets you attach new behaviors to objects by placing these objects inside special wrapper objects that contain the behaviors.](/design-patterns/decorator)
[Facade

Provides a simplified interface to a library, a framework, or any other complex set of classes.](/design-patterns/facade)
[Flyweight

Lets you fit more objects into the available amount of RAM by sharing common parts of state between multiple objects instead of keeping all of the data in each object.](/design-patterns/flyweight)
[Proxy

Lets you provide a substitute or placeholder for another object. A proxy controls access to the original object, allowing you to perform something either before or after the request gets through to the original object.](/design-patterns/proxy)
...
* English
  ...
  [English](https://refactoring.guru/design-patterns/structural-patterns "English")
  [Español](https://refactoring.guru/es/design-patterns/structural-patterns "Español")
  [Français](https://refactoring.guru/fr/design-patterns/structural-patterns "Français")
  [日本語](https://refactoring.guru/ja/design-patterns/structural-patterns "日本語")
  [한국어](https://refactoring.guru/ko/design-patterns/structural-patterns "한국어")
  [Polski](https://refactoring.guru/pl/design-patterns/structural-patterns "Polski")
  [Português Brasileiro](https://refactoring.guru/pt-br/design-patterns/structural-patterns "Português Brasileiro")
  [Русский](https://refactoring.guru/ru/design-patterns/structural-patterns "Русский")
  [Українська](https://refactoring.guru/uk/design-patterns/structural-patterns "Українська")
  [中文](https://refactoringguru.cn/design-patterns/structural-patterns "中文")
