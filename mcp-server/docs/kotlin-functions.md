...
Functions | Kotlin Documentation[{"id":"function-usage","level":0,"title":"Function usage","anchor":"#function-usage"},{"id":"parameters","level":1,"title":"Parameters","anchor":"#parameters"},{"id":"parameters-with-default-values","level":1,"title":"Parameters with default values","anchor":"#parameters-with-default-values"},{"id":"named-arguments","level":1,"title":"Named arguments","anchor":"#named-arguments"},{"id":"return-types","level":1,"title":"Return types","anchor":"#return-types"},{"id":"single-expression-functions","level":1,"title":"Single-expression functions","anchor":"#single-expression-functions"},{"id":"unit-returning-functions","level":1,"title":"Unit-returning functions","anchor":"#unit-returning-functions"},{"id":"variable-number-of-arguments-varargs","level":1,"title":"Variable number of arguments (varargs)","anchor":"#variable-number-of-arguments-varargs"},{"id":"infix-notation","level":1,"title":"Infix notation","anchor":"#infix-notation"},{"id":"function-scope","level":0,"title":"Function scope","anchor":"#function-scope"},{"id":"local-functions","level":1,"title":"Local functions","anchor":"#local-functions"},{"id":"member-functions","level":1,"title":"Member functions","anchor":"#member-functions"},{"id":"generic-functions","level":0,"title":"Generic functions","anchor":"#generic-functions"},{"id":"tail-recursive-functions","level":0,"title":"Tail recursive functions","anchor":"#tail-recursive-functions"}]{
"@context": "http://schema.org",
"@type": "WebPage",
"@id": "https://kotlinlang.org/docs/functions.html#webpage",
...
Kotlin functions can receive other functions as parameters — and be passed as arguments. For more information, see [Higher-order functions and lambdas](lambdas.html).
...
[Exception and error handling](exceptions.html)[Higher-order functions and lambdas](lambdas.html)