...
Collections overview | Kotlin Documentation[{"id":"collection-types","level":0,"title":"Collection types","anchor":"#collection-types"},{"id":"collection","level":1,"title":"Collection","anchor":"#collection"},{"id":"list","level":1,"title":"List","anchor":"#list"},{"id":"set","level":1,"title":"Set","anchor":"#set"},{"id":"map","level":1,"title":"Map","anchor":"#map"},{"id":"arraydeque","level":1,"title":"ArrayDeque","anchor":"#arraydeque"}]{
"@context": "http://schema.org",
"@type": "WebPage",
"@id": "https://kotlinlang.org/docs/collections-overview.html#webpage",
"url": "https://kotlinlang.org/docs/collections-overview.html",
"name": "Collections overview | Kotlin",
"description": "",
...
Arrays are not a type of collection. For more information, see [Arrays](arrays.html).
...
[Create a Kotlin app that answers questions with Spring AI — tutorial](spring-ai-guide.html)[Constructing collections](constructing-collections.html)