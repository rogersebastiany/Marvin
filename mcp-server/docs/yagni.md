...
[process theory](/tags/process%20theory.html)

[project planning](/tags/project%20planning.html)
...
Need It”. It is a mantra from [ExtremeProgramming](/bliki/ExtremeProgramming.html)
...
Beck and Chet Hendrickson on the [C3](/bliki/C3.html) project. Chet
...
accumulated [TechnicalDebt](/bliki/TechnicalDebt.html) and have to
...
practices like [SelfTestingCode](/bliki/SelfTestingCode.html) and
[ContinuousDelivery](/bliki/ContinuousDelivery.html). These are [enabling practices for evolutionary
design](/articles/designDead.html), without them yagni turns from a beneficial practice into
...
My essay [Is Design
Dead](/articles/designDead.html) talks in more detail about the role of design and
