...
### [Patterns for Managing Source Code Branches](/articles/branching-patterns.html)
...
[Read more…](/articles/branching-patterns.html)

article

[continuous delivery](/tags/continuous%20delivery.html) [collaboration](/tags/collaboration.html) [version control](/tags/version%20control.html)
...
### [Continuous Integration](/books/duvall.html)
...
understand the history of the system, using [Diff Debugging](/bliki/DiffDebugging.html) to find bugs. As I write this, the dominant
...
the build products in source control, but I consider that to be a [smell](/bliki/CodeSmell.html)
...
having a clear [mainline](/articles/branching-patterns.html#mainline) - a single,
...
There's a common confusion about the term “integration”. Many people
...
to mainline doesn't break their branch.

But this isn't the full integration process. Full [mainline integration](/articles/branching-patterns.html#mainline-integration) requires that
...
### [Continuous Integration Certification](/bliki/ContinuousIntegrationCertification.html)
...
[Read more…](/bliki/ContinuousIntegrationCertification.html)

bliki

[certification](/tags/certification.html) [continuous delivery](/tags/continuous%20delivery.html)
...
### [Continuous Delivery](/books/continuousDelivery.html)
...
[Read more…](/books/continuousDelivery.html)
...
### [Infrastructure As Code](/bliki/InfrastructureAsCode.html)
...
[ReproducibleBuilds](/bliki/ReproducibleBuild.html), subject to testing practices, and the full discipline of
[ContinuousDelivery](/bliki/ContinuousDelivery.html). It's an approach that's been used over the last decade to
deal with growing [CloudComputing](/bliki/CloudComputing.html) platforms and will become the dominant way
...
[Read more…](/bliki/InfrastructureAsCode.html)

bliki

[continuous delivery](/tags/continuous%20delivery.html) [microservices](/tags/microservices.html)
...
### [Evolutionary Database Design](/articles/evodb.html)

Over the last decade we've developed and refined a number of techniques that
...
[Read more…](/articles/evodb.html)

article

[agile](/tags/agile.html) [refactoring](/tags/refactoring.html) [application architecture](/tags/application%20architecture.html) [database](/tags/database.html) [evolutionary design](/tags/evolutionary%20design.html)
...
document.addEventListener('DOMContentLoaded', () => {new Carousel('ci-dance')})