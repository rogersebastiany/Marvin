...
class TestSafeDiagramPath:
    def test_valid_path(self):
        from system_design_backend import _safe_diagram_path
...
class TestGenerateDiagram:
    def test_includes_description(self):
        from system_design_backend import generate_diagram
...
class TestJudgeDiagram:
    def test_includes_code(self):
        from system_design_backend import judge_diagram
...
class TestSaveDiagram:
    def test_saves_to_file(self, tmp_path):
        from system_design_backend import save_diagram
        with patch("system_design_backend.DIAGRAMS_DIR", tmp_path):
    ...
    def test_invalid_path(self):
        from system_design_backend import save_diagram
        with patch("system_design_backend._safe_diagram_path", return_value=None):
...
class TestListDiagrams:
    def test_lists_mmd_files(self, tmp_path):
        ...
        with patch("system_design_backend.DIAGRAMS_DIR", tmp_path):
            from system_design_backend import list_diagrams
...
class TestGetDiagram:
    def test_reads_file(self, tmp_path):
        ...
        with patch("system_design_backend.DIAGRAMS_DIR", tmp_path):
            from system_design_backend import get_diagram
...
class TestConstants:
    def test_diagram_guidelines_has_types(self):
        from system_design_backend import DIAGRAM_GUIDELINES
