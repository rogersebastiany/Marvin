...
class TestSystemPrompt:
    def test_has_required_sections(self):
        from prompt_engineer_backend import SYSTEM_PROMPT
...
class TestBuildToolCatalog:
    def test_empty_list(self):
        from prompt_engineer_backend import _build_tool_catalog
...
class TestGeneratePrompt:
    def test_includes_task_and_domain(self):
        from prompt_engineer_backend import generate_prompt
...
class TestRefinePrompt:
    def test_includes_original_and_feedback(self):
        from prompt_engineer_backend import refine_prompt
...
class TestAuditPrompt:
    def test_includes_prompt_to_audit(self):
        from prompt_engineer_backend import audit_prompt
